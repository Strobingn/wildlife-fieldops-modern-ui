...
export function createStore(initialState) {
  ...
  // Freeze initial state to enforce immutability without expensive deep cloning
  ...
  return {
     ...
     * Avoids expensive JSON deep cloning on every state read.
     * @returns {T}
     */
    getState() {
      return state;
     ...
     * Enforces immutability via Object.freeze instead of deep cloning state.
